...
BOT_TOKEN = environ.get('BOT_TOKEN', "8269129164:AAEboYvpxJ8RpRbFKH4Obe6KZBIu3ZFJeiY")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1003036018855').split()]  # For Multiple Id Use One Space Between Each.
